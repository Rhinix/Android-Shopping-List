...
class ShoppingListActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listView_details.setOnItemClickListener { parent, view, position, id ->
            ...
            intent.putExtra(
                "listId",
                (listView_details.getItemAtPosition(position) as ShoppingList).id
            )
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                runOnUiThread {
                    ...
                    val obj_adapterShopping: ShoppingListAdapter =
                        ShoppingListAdapter(applicationContext, arrayList_details)
